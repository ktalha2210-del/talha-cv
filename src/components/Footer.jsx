    ...
    <footer className="footer">
      ...
      <div className="container footer__inner">
        ...
        <div className="footer__links">
          ...
          <a href="#projects" className="footer__link" onClick={e => { e.preventDefault(); document.getElementById('projects')?.scrollIntoView({ behavior: 'smooth' }); }}>Case Studies</a>
          <a href="#linkedin-posts" className="footer__link" onClick={e => { e.preventDefault(); document.getElementById('linkedin-posts')?.scrollIntoView({ behavior: 'smooth' }); }}>LinkedIn Posts</a>
        ...
        <div className="footer__socials">
          ...
          <a href="https://drive.google.com/file/d/1-rB7tvLeEMGCMPXr32CwHa3RBIZruFEr/view?usp=sharing" target="_blank" rel="noopener noreferrer" id="footer-cv" className="footer__social" title="Resume / CV">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
