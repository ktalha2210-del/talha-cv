      ...
      <div className="container footer__inner">
        <div className="footer__left">
          ...
          <p className="footer__tagline">
            Aspiring Product Manager · Building products that matter.
          </p>
        </div>
        ...
        <div className="footer__socials">
          ...
          <a href="https://drive.google.com/file/d/1s9xwJv_WSj4WD-OxTHkU9ERTShLtjLKg/view?usp=sharing" target="_blank" rel="noopener noreferrer" id="footer-cv" className="footer__social" title="Resume / CV">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
